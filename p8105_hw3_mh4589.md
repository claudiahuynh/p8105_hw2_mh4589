...
```
    ...
    ## # A tibble: 5 × 3
    ##   start_station_name       numer_of_rides start_station_rank
    ##   <chr>                             <int>              <int>
    ## 1 Pier 61 at Chelsea Piers            163                  1
    ## 2 University Pl & E 14 St             155                  2
    ## 3 W 21 St & 6 Ave                     152                  3
    ## 4 West St & Chambers St               150                  4
    ## 5 W 31 St & 7 Ave                     146                  5
...
![](p8105_hw3_mh4589_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
