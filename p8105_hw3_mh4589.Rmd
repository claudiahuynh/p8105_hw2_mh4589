...
The dataset NY NOAA provies information on temperature, snowfall, snow depth and precipitation everyday starting from 1981 at different weather stations in NY. There is extensive

There are `nrow(ny_noaa)` rows and `ncol(ny_noaa)` columns. 
