...
Load, tidy, merge and organize the acceleration and demographic datasets. Chagne education to 1. less than high school, 2 is high school equivalent, 3 is more than high school. Make a boxplot as the first figure 
```{r}
accel_df =
